...
cd $CWD
snakemake --nolock -s Snakefile --jobs 6 --executor slurm --profile slurm_profile --rerun-incomplete --default-resources mem_mb=72000 ntasks=1 threads=8 runtime=550 cpus_per_task=8