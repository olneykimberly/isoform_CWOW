...
samples_selected <- read.delim("metadata/long_read_sample_selection_replacement_samples.txt")
...
write.table(sample_submission_info, "metadata/sample_submission_info_replacement_samples.txt", sep = "\t", quote = FALSE, row.names = FALSE)
summary(sample_submission_info$Tapestation_DIN_or_RIN)
...
write.table(df_batched, "metadata/sample_submission_info_with_SMRTcell_replacement_samples.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(df_batched, "/Users/kolney/Desktop/sample_updated_batches_updated_replacement_samples.txt", sep = "\t", quote = FALSE, row.names = FALSE)
